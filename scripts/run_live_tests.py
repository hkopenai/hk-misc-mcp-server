"""
Script to run live tests for the HK OpenAI MCP Server.

This script sets up the environment to run live tests using pytest,
allowing for specific test selection or running all live tests.
"""
